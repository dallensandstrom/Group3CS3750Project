...
namespace GroupThreeTrailerParkProject.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PaymentID,ReservationID,Amount,PaymentDate,PaymentType,StripePaymentID,Status")] Payment payment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PaymentID,ReservationID,Amount,PaymentDate,PaymentType,StripePaymentID,Status")] Payment payment)
        {
