...
namespace GroupThreeTrailerParkProject.Controllers
{
    ...
    public class FeesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FeeID,Name,Amount,AppliesTo")] Fee fee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FeeID,Name,Amount,AppliesTo")] Fee fee)
        {
            if (id != fee.FeeID)
            {
                return NotFound();
